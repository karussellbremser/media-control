    ...
    def addSingleMediaWoConnections(self, thisMedia):
        ...
        for mediaVersion in thisMedia.mediaVersions:
            ...
            versionColumns = [
                ...
                "color_space", "chroma_subsampling", "chroma_subsampling_position", "bit_depth", "scan_type",
                "language", "title",
            ...
            versionValues = [
                ...
                mediaVersion.color_space, mediaVersion.chroma_subsampling, mediaVersion.chroma_subsampling_position, mediaVersion.bit_depth, mediaVersion.scan_type,
